...
const routes = [
    ...
    {
        path: 'tabs',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_members_tabs_tabs_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./members/tabs/tabs.module */ 18405)).then(m => m.TabsPageModule),
    },
    {
        path: '',
        redirectTo: '/login',
